...
saturation) satisfy the same Anti-Zeno constraint and are
expected to produce qualitatively similar shell formation
behavior, as all share the essential property $g \to 0$ at
large gradients~\cite{transport_deriv}.
