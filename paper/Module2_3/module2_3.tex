...
The linear form is the minimal (first-order) member of this
admissible class; higher-order forms (exponential, Lorentzian,
saturation) satisfy the same Anti-Zeno constraint and produce
the same shell formation result.
Numerical confirmation on a $20^3$ lattice shows all three
forms give $C = 1.0198 \pm 0.0002$, with spread $\Delta C = 0.00003$
across forms --- confirming that the fixed point is a property
of the admissible class, not of the linear choice~\cite{transport_deriv}.
